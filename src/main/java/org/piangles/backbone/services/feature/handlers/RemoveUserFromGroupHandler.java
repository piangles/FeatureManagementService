...
public class RemoveUserFromGroupHandler extends AbstractHandler
{
	public RemoveUserFromGroupHandler(LoggingService logger, FeatureManagementConfiguration fmConfig, FeatureManagementServiceDAO fmsDAO)
	{
